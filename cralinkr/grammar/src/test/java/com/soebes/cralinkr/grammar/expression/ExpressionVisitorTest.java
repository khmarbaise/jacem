...
class ExpressionVisitorTest {
  ...
  static Stream<Arguments> parseExpressions() {
    return Stream.of(arguments("Addition", "3+5", 8L), arguments("Multiplication", "3*5", 15L),
        arguments("Subtraction", "1024-256", 768L), arguments("Division", "1024/256", 4L),
        arguments("Check for precedence", "2*(3+4)", 14L), arguments("Check for precedence", "2+3*2", 8L),
        arguments("Unary simple", "-1024+3072", 2048L), arguments("Unary complex", "-1024-(-1024)", 0L),
        arguments("Hex value", "$1000", 4096L), arguments("Hex value", "$FFFF", 65535L),
        ...
        arguments("Hex value with separator", "$1_000", 4096L), arguments("binary value", "0b10000000", 128L),
        ...
        arguments("octal value", "0o200", 128L), arguments("octal value with separator", "0o2_00", 128L),
        ...
        arguments("Modulo Operation", "128%16", 0L), arguments("Modulo Operation", "129%15", 9L),
